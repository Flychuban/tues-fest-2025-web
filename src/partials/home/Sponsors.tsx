...
function randomStartIndex(podkrepqshti: Podkrepqsht[]) {
...
const Sponsors = () => (
	<section id="sponsors" className="relative z-20 mb-20 p-8 md:p-12">
		...
		<PodkrepqAutoDisplay podkrepqshti={ALPHA_SPONSORS} startIndex={randomStartIndex(ALPHA_SPONSORS)} />
		<h2 className="text-accent-foreground font-title mb-4 mt-32 text-center text-3xl font-black">Бета Спонсори</h2>
		<PodkrepqAutoDisplay podkrepqshti={BETA_SPONSORS} startIndex={randomStartIndex(BETA_SPONSORS)} />
		<h2 className="text-accent-foreground font-title mb-4 mt-32 text-center text-3xl font-black">Гама Спонсори</h2>
		<PodkrepqAutoDisplay podkrepqshti={GAMMA_SPONSORS} startIndex={randomStartIndex(GAMMA_SPONSORS)} />
		<h2 className="text-accent-foreground font-title mb-4 mt-32 text-center text-3xl font-black">Партньори</h2>
		<PodkrepqAutoDisplay podkrepqshti={PARTNERS} startIndex={randomStartIndex(PARTNERS)} />
		<h2 className="text-accent-foreground font-title mb-4 mt-32 text-center text-3xl font-black">
			Медийни Партньори
		</h2>
		<PodkrepqAutoDisplay podkrepqshti={MEDIA_PARTNERS} startIndex={randomStartIndex(MEDIA_PARTNERS)} />
	</section>
);
