...
const PARTNERS = [
	{
		...
		url: 'https://www.a1.bg/',
		description:
			'А1 България е лидер в телекомуникациите, системната интеграция и ICT услугите в страната. Част от A1 Group, ние предлагаме иновативни дигитални решения, подплатени със сертификат Great Place to Work за 2023 година, който ни нарежда сред най-добрите работодатели в Европа.\nС екип от близо 4000 професионалисти, ние предоставяме богато портфолио: IoT услуги, облачни решения, системна интеграция и много други. Партнираме с водещи световни компании като Microsoft, IBM, Cisco и Netflix, за да бъдем доверен избор за бизнес и частни клиенти в България.\nВсичко това не би било възможно без екипа ни от над 600 IT експерти, които ежедневно създават и поддържат решения, на които клиентите ни разчитат.',
	},
	{
		name: 'АЗТУЕС',
		logo: aztuesLogo,
